...
This assignment uses scipy kruskal test, and chisquare test to evaluate the threshold differences, and use the coefficient of threshold indicator generated by regression model to evaluate its impact to dependent variable, giving light on the problem whether it worths the bank to invest on debt collection.
